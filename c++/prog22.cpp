...
class BOX {
		...
		BOX() 
	 	...
	 	BOX(double LENGTH)
		{
			cout<<"\nconstructor with single argument is being called !!! \n";
			length=breadth=height=LENGTH;
              		cout<<" BOX created !!! \n";
		}
		
		BOX(double LENGTH, double BREADTH, double HEIGHT) 
		{	cout<<"\nconstructor with three arguments is being called !!! \n";
	...
	void BOX::getdata()
	 {	
		int choice;
		double len=0,bread=0,heig=0;
		cout<<"\nWhat do u want to create :  1.cube  2.cuboid  \n ";
	 		int counter=-1;
		do{ 
			counter++;
			if(counter==1)
...
do{
	...
	cout<<" 5:ASSIGNMENT OF ONE BOX TO OTHER"<<endl<<endl;
